...
export FIRST_STAGE_MODEL="outputs/viewsynthesis_model"  # Path to your first stage model
export DATA_DIR="data/transformation/transformation_dataset.jsonl"
...
echo "Starting training with Rotational Encoding method..."

export OUTPUT_DIR="outputs/transformation_rotational_encoding"
